...
//        }
        ...
        client.create("/test","test".getBytes(),ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.CONTAINER);
        client.create("/test/","test".getBytes(),ZooDefs.Ids.OPEN_ACL_UNSAFE,CreateMode.EPHEMERAL_SEQUENTIAL);
//        for (int i = 0; i<10;i++){
